      ...
      <el-col :span="12">
        <div class="panel">
          <div class="panel-header">
            ...
            <el-button type="text" @click="$router.push('/user/restock')">查看全部</el-button>
          </div>
      ...
      <el-col :span="12">
        <div class="panel">
          ...
          <div class="quick-actions">
            <el-card shadow="hover" class="action-card" @click.native="$router.push('/user/search')">
              <div class="action-icon">
                <i class="el-icon-search"></i>
              </div>
              <div class="action-text">零件搜索</div>
            </el-card>
            <el-card shadow="hover" class="action-card" @click.native="$router.push('/user/stock')">
              <div class="action-icon">
                <i class="el-icon-upload2"></i>
              </div>
              <div class="action-text">入库/出库</div>
            </el-card>
            <el-card shadow="hover" class="action-card" @click.native="$router.push('/user/records')">
              <div class="action-icon">
                <i class="el-icon-document"></i>
              </div>
              <div class="action-text">出入库记录</div>
            </el-card>
            <el-card shadow="hover" class="action-card" @click.native="$router.push('/user/restock')">
              <div class="action-icon">
                <i class="el-icon-warning"></i>
              </div>
